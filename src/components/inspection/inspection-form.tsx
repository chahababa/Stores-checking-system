            ...
            <div className="mt-5 grid gap-4">
              <div className="rounded-[20px] border border-ink/10 bg-white p-4">
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-2 block text-sm text-ink/70">內用重量（克）</label>
                    <input
                      type="number"
                      inputMode="decimal"
                      min={0}
                ...
                <div className="mt-4">
                  <label className="mb-2 block text-sm text-ink/70">內用餐點觀察 / 製餐過程備註</label>
                  <textarea
              ...
              <div className="rounded-[20px] border border-ink/10 bg-white p-4">
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div>
                    <label className="mb-2 block text-sm text-ink/70">外帶重量（克）</label>
                    <input
                      type="number"
                      inputMode="decimal"
                      min={0}
                ...
                <div className="mt-4">
                  <label className="mb-2 block text-sm text-ink/70">外帶餐點觀察 / 製餐過程備註</label>
                  <textarea
